...
def setup_parser():
    ...
    parser_tmp.add_argument("--session-name", default="5", help="Name of a tmux console")
    ...
    parser_tmp.add_argument("--tpu-name", default="bert5", help="tpu name to run")
    ...
    parser_tmp.add_argument("--gcp-model-dir", default="bert-bucket-golkarolka/bert_model5")
    parser_tmp.add_argument("--pretraining-dir", default="bert-bucket-golkarolka/pretrain_data5")
    return parser_tmp
